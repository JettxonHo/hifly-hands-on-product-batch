...
const nullableJson = (value) => value == null ? null : JSON.stringify(value);
...
function uow(client) {
  return {
    ...
    async insertRevision(value) {
      ...
      [value.id, value.organization_id, value.project_id, value.product_id, value.status, value.revision_number, value.product_name, value.product_description, value.primary_category, JSON.stringify(value.content_brief), nullableJson(value.physical_dimensions), JSON.stringify(value.asset_version_ids), JSON.stringify(value.selling_points), value.parent_revision_id, value.created_by_member_id, value.created_at, value.updated_at, value.ready_at]);
    },
    async updateRevision(value) {
      ...
      [value.id, value.status, value.revision_number, value.product_name, value.product_description, value.primary_category, JSON.stringify(value.content_brief), nullableJson(value.physical_dimensions), JSON.stringify(value.asset_version_ids), JSON.stringify(value.selling_points), value.updated_at, value.ready_at]);
    },
