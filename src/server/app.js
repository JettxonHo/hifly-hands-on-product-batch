...
function apiError(error, request = null) {
  ...
  if (["WORK_VERIFICATION_CONFLICT", "WORK_VERIFICATION_PRIMARY_WORK_EXISTS", "WORK_VERIFICATION_RETRY_BLOCKED",
    "WORK_VERIFICATION_RETRY_EXHAUSTED", "WORK_VERIFICATION_RECOVERY_BLOCKED", "WORK_VERIFICATION_LEASE_LOST",
