...
| [PRODUCT_APPEARANCE_FIDELITY_DOMAIN_API.md](PRODUCT_APPEARANCE_FIDELITY_DOMAIN_API.md) | D-036 / Fidelity-A 的领域与 additive API Specification：生产前独立候选门禁、受控候选 AssetVersion、自动检查/人工审核状态、Production 硬门禁、恢复/费用/兼容与 TDD 切片；不代表实现或部署 |
