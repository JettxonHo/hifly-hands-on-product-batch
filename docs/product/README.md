...
| [DECISION_LOG.md](DECISION_LOG.md) | 正式产品决策记录（D-001 ～ D-023）；最新：D-023 MVP DeepSeek 官方 LLM Provider 与生成运行契约 |
| [OPEN_QUESTIONS.md](OPEN_QUESTIONS.md) | 开放问题记录（已关闭问题保留结论，Q-019 已由 D-023 解决；未关闭问题任何角色不得擅自代替 owner 决定） |
