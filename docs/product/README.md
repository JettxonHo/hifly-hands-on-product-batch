...
| [VERTICAL_SLICE_A_DELIVERY_PLAN.md](VERTICAL_SLICE_A_DELIVERY_PLAN.md) | D-030 的交付计划 Specification：Vertical Slice A 交付目标、Issue 拆分原则、VSA-A01～A14 边界、依赖波次、Issue 模板、单 Issue DoD、Slice 级 DoD；不代表 Development Issues 已创建或开发已开始 |
| [DECISION_LOG.md](DECISION_LOG.md) | 正式产品决策记录（D-001 ～ D-030）；最新：D-030 Vertical Slice A 交付计划与完成定义 |
