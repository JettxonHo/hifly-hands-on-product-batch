...
- 本机已有 3 个可用商品图：iPad、吉伊卡哇玩偶、熊玩偶；本机私有目录已有 1 个人物映射和对应人物图。为满足验收合同仍缺 1 张有使用授权的人物图及其企业人物登记/本地映射。
- P2-02/P2-03 已进入 `main@b0e47ab`，但阿里云试运行环境尚未部署这些 migration 和 GUI；当前不能把本地合并状态视为云端人物目录/推荐可用。
- 下一门禁：Owner 需要提供或确认第 2 张人物图，并明确授权部署当前 main 到阿里云。部署、migration、standby 检查完成后，才逐条准备 3 个批准工单并使用 standing authorization；本轮未部署、未访问飞影、未领取工单、积分消耗 0。
